...
from Operations.Patient import Patient
from Operations.Therapist import Therapist
...
class EmoSenseApp:
    ...
    def _register_before_request(self) -> None:
        ...
        def load_model() -> None:
            if os.path.exists(r'C:\Users\User\Desktop\FYP-II\EmoSense-server\Core\therapy_emotion_model.h5'):
